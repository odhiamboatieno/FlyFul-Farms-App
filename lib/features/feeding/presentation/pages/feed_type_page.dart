      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            _buildPageHeaderStepper(context, 'Feed Batch 012', 'First question'),
            ...
            Wrap(
              ...
              children: _foodTypes.asMap().entries.map((entry) {
                ...
                return _buildChoice(data['icon'], data['label'], isSelected: _selectedIndex == i, onTap: () => setState(() => _selectedIndex = i));
              }).toList(),
            ),
